		...
		<Card className="p-4">
			...
			<CardContent className="mt-2 p-0">
				...
				<ul className="ml-5 list-disc">
					...
					<li>
						Halyk Visa {"->"}{" "}
						<Button className="p-0" variant={"link"} onClick={copyToClipboard("4405639703506988")}>
							4405 6397 0350 6988
						</Button>
					</li>
					<li>
						Paypal {"->"}{" "}
						<Button className="p-0" variant={"link"} onClick={copyToClipboard("artyom.chshyogolev@gmail.com")}>

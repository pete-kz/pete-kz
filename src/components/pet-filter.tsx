...
export default function PetFilter({
  ...
  updateFilter: (filter: Pet_Filter) => void
  filter: Pet_Filter
  ...
  const [sterilized, setSterilized] = useState<Pet_Filter["sterilized"]>(
    filter.sterilized,
  )
  ...
  const [ownerType, setOwnerType] = useState<Pet_Filter["owner_type"] | string>(
    filter.owner_type,
  )
